...
/**
 * Data source for the AddTouristToFlight view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class AddTouristToFlightDataSource extends DataSource<flight> {
  data: flight[] = [];
  ...
  connect(): Observable<flight[]> {
    const allflights: Observable<flight[]> = this.flightServ.getflights()
    .pipe(map(data => {
      this.data = data;
