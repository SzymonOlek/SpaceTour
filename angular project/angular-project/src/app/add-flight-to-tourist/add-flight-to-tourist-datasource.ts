...
/**
 * Data source for the AddFlightToTourist view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class AddFlightToTouristDataSource extends DataSource<tourist> {
  data: tourist[] = [];
  ...
  connect(): Observable<tourist[]> {
    const alltourists: Observable<tourist[]> = this.touristsServ.gettourists()
    .pipe(map(data => {
      this.data = data;
